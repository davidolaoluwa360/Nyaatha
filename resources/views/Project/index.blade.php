...
@section('ourproject')
    <section class='ourprojectoutergeneralcontainer'>
        ...
        <div class='ourprojectinnergeneralcontainer'>
            <div class='farmingimage farming-image-container-select' data-aos='fade-up' data-aos-duration='700' data-aos-delay='700' data-aos-once='true'>
            ...
            <div class='farmingdescription' data-aos='fade-right' data-aos-duration='700' data-aos-delay='800' data-aos-once='true'>
            ...
            <div class='farmingimage poultry-image-select' data-aos='fade-right' data-aos-duration='600' data-aos-dalay='600' data-aos-once='true'>
                <aside>
            ...
            <div class='farmingdescription' data-aos='fade-right' data-aos-duration='700' data-aos-once='true'>
                ...
                <p>The Fund has mostly obtained the finances from the well-wishers. Through the farm made possible by
                    the Assumption Sisters of Eldoret who agreed to give part of their farm to NEEF to use for raising funds,
                ...
                <div class='project-Donation-general-container'>
                    <div class='project-Donate' data-aos='fade-right' data-duration ='800' data-aos-delay='700' data-aos-once='true'>
                        <div class='project-donate-fonts'>
                            <i class="fas fa-money-check-alt" title='close'></i>
                        </div>
                        <span class='project-pop-up'>Donate</span>
                    </div>

                    <div class='project-loan' data-aos='fade-right' data-duration='800' data-aos-delay='600' data-aos-once='true'>
                        <div class='project-donate-fonts'>
                            <i class="fas fa-money-bill-alt"></i>
                        </div>
                            <span class='project-pop-up'>Soft-Loan</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class='project-donate-general-container-selector'>
        <div class='project-donate-inner-container-selector'>
            ...
            <div class='project-donate-post-modal-popup'>
                ...
                <ul>
                    <li><span class='list-group-item'>Bank Deposit/Transfer: </span>ABC Bank Account Number: 002234001000037</li>
                ...
                <span>For more information on how you can use the above modes of donation, kindly send an inquiry to:</span><br>
