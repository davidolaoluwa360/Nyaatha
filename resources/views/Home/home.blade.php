      ...
      <div class="our-mission-vission-right-container-selector">
        ...
        <div class="our-mission-vission-header-text header-header">
          ...
          <div class="Dvission-vision-selector" style='overflow: hidden'>
            ...
            <div class="Dvission-vision-left-selector Dvission-vision-select" data-aos="fade-right" data-aos-duration='600' data-aos-once='true'>
            ...
            <div class="Dvission-vision-right-selector Dvission-vision-select" data-aos="fade-right" data-aos-duration='600' data-aos-delay='500' data-aos-once='true'>
            ...
            <div class="DOur-Aim-left-selector Dvission-vision-select" data-aos="fade-up" data-aos-duration='600' data-aos-delay='400' data-aos-once='true'>
            ...
            <div class="Dvalues-right-selector Dvission-vision-select" data-aos="fade-right" data-aos-duration='600' data-aos-delay='300' data-aos-once='true'>
  ...
  <section class="our-program-statistics-data-outer-general-container">
    <div class="our-program-statisctics-data-inner-container">
      ...
      <div class="our-program-data-stats-header-selector">
        <span>Our Stats</span>
        <span class="program-data-stats-header-bold">Our Life Changing Programs Are Reaching Out To Hundreds of Thousands</span>
      </div>
  ...
  <section class="nyaatha-image-pouter-general-container">
    <div class="nyaatha-image-inner-container-selector">
      ...
      <div class="Dgallery-inner-container" style='overflow: hidden'>
        ...
        <aside data-aos='fade-up' class='showall workshops' data-aos-duration='600' data-aos-once='true'>
            <img src="{{URL::to('Images/WhatsApp Image 2020-05-18 at 8.26.19 PM.jpeg')}}">
        </aside>

        <aside data-aos='fade-in' class='showall workshops' data-aos-duration='600' data-aos-delay='800' data-aos-once='true'>
            <img src="{{URL::to('Images/WhatsApp Image 2020-05-18 at 8.26.16 PM.jpeg')}}">
        </aside>

        <aside data-aos='fade-right' class='showall workshops' data-aos-duration='600' data-aos-delay='700' data-aos-once='true'>
        ...
        <aside data-aos='fade-in' class='showall training' data-aos-duration='600' data-aos-delay='400' data-aos-once='true'>
        ...
        <aside data-aos='fade-right' class='showall training' data-aos-duration='600' data-aos-delay='200' data-aos-once='true'>
...
@section('ourpartners')
  <section class="Our-partners-outer-general-container">
    ...
    <div class="Our-partners-inner-general-container" style='overflow:hidden'>
        ...
        <div data-aos='fade-right' data-aos-duration='600' data-aos-delay='500' data-aos-once='true'><span>Diomira Foundation</span></div>
        <div data-aos='fade-in' data-aos-duration='600' data-aos-delay='400' data-aos-once='true'><span>Lorcan Investments</span></div>
        <div data-aos='fade-right' data-aos-duration='600' data-aos-delay='300' data-aos-once='true'><span>Aises Academy</span></div>
        </div>
    </div>
  </section>
@endsection
